...
if(isset($_POST['but_search']))
{
  ...
  $sql = "SELECT TOP 500 * FROM Washlog";
  
  if(!empty($fromDate) && !empty($endDate))
  {
	$sql .= " WHERE Time BETWEEN #".$fromDate."# and #".$endDate."#";
  }
...
echo "<th>Ccalc_dip</th>";
echo "<th>Ccalc_tireshine</th>";
echo "<th>Ccalc_shinelux</th>";
echo "<th>Ccalc_rainlux</th>";
echo "<th>Ccalc_lavafoam</th>";
echo "<th>Ccalc_insect</th>";
echo "<th>Ccalc_airwax</th>";
echo "</tr>";
echo "</div>";
...
while (odbc_fetch_row($rs))
{
  ...
  $Ccalc_dip=odbc_result($rs,"Ccalc_dip");
  $Ccalc_tireshine=odbc_result($rs,"Ccalc_tireshine");
  $Ccalc_shinelux=odbc_result($rs,"Ccalc_shinelux");
  $Ccalc_rainlux=odbc_result($rs,"Ccalc_rainlux");
  $Ccalc_lavafoam=odbc_result($rs,"Ccalc_lavafoam");
  $Ccalc_insect=odbc_result($rs,"Ccalc_insect");
  $Ccalc_airwax=odbc_result($rs,"Ccalc_airwax");
  ...
  echo "<td>$Ccalc_dip</td>";   
  echo "<td>$Ccalc_tireshine</td>";   
  echo "<td>$Ccalc_shinelux</td>";   
  echo "<td>$Ccalc_rainlux</td>";   
  echo "<td>$Ccalc_lavafoam</td>";   
  echo "<td>$Ccalc_insect</td>";   
  echo "<td>$Ccalc_airwax</td>";   
  echo "</tr>";
}
odbc_close($conn);
echo "</table>";
