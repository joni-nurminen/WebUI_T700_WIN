require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO2_Out.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,LangSupport,resources,ready,registry){
			return  declare("DebugIOData_IO2_Out", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
				templateString: template,
				card_2_out : resources.card_2_out,
			...
			//	this.IO1Store = new Memory();
				this.IO2Store = new Cache(new JsonRest({target:"get_debugio_data.php/2_out"}), new Memory());
