require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO5_Out.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,resources,LangSupport,ready,registry){
			return  declare("DebugIOData_IO5_Out", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
				templateString: template,
				card_5_out : resources.card_5_out,
			...
			//	this.IO5Store = new Memory();
				this.IO5Store = new Cache(new JsonRest({target:"get_debugio_data.php/5_out"}), new Memory());
