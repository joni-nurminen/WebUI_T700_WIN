require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO1.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,LangSupport,resources,ready,registry){
			return  declare("DebugIOData_IO1", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
		templateString: template,
		card_1 : resources.card_1,
