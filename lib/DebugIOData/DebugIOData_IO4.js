require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO4.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,resources,LangSupport,ready,registry){
			return  declare("DebugIOData_IO4", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
				templateString: template,
				card_4 : resources.card_4,
			...
			//	this.IO4Store = new Memory();
				this.IO4Store = new Cache(new JsonRest({target:"get_debugio_data.php/4_in"}), new Memory());
