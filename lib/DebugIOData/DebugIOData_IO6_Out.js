require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO6_Out.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,resources,LangSupport,ready,registry){
			return  declare("DebugIOData_IO6_Out", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
				templateString: template,
				card_6_out : resources.card_6_out,
			...
			//	this.IO6Store = new Memory();
				this.IO6Store = new Cache(new JsonRest({target:"get_debugio_data.php/6_out"}), new Memory());
