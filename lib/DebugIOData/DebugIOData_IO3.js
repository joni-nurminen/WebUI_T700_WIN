require([
	...
	"dojo/text!./lib/DebugIOData/templates/DebugIOData_IO3.html",
	"dgrid/OnDemandGrid",
	"dgrid/Selection", 
	"dgrid/selector", 
	"dojo/store/Memory",
	...
	"dijit/registry",
		...
		function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Grid,Selection,selector,Memory,JsonRest,json,Cache,resources,LangSupport,ready,registry){
			return  declare("DebugIOData_IO3", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
				
				templateString: template,
				card_3 : resources.card_3,
			...
			//	this.IO3Store = new Memory();
				this.IO3Store = new Cache(new JsonRest({target:"get_debugio_data.php/3_in"}), new Memory());
